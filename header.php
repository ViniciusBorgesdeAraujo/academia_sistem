...
<script>
ew.ready("head", ["https://www.youtube.com/iframe_api", "<?php echo $RELATIVE_PATH ?>js/ewyoutubevideos.js"], "youtubevideos");
</script>
<script>
...
<?php include_once $RELATIVE_PATH . "cookieconsent.php"; ?>
	...
	<nav class="<?php echo Config("NAVBAR_CLASS") ?>">
		...
		<ul id="ew-navbar" class="navbar-nav">
			...
			<a class="navbar-brand d-none" href="#"  onclick="return false;">
				<span class="brand-text">FitHome Studio</span>
			</a>
		</ul>
		<!-- Right navbar links -->
