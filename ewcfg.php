...
// Project
define(PROJECT_NAMESPACE . "PROJECT_NAME", "sistema"); // Project name
...
$CONFIG = [
	...
	"RANDOM_KEY" => 'Nox5CNsPH9N1X5I7', // Random key for encryption
	"ENCRYPTION_KEY" => '', // Encryption key for data protection
	"PROJECT_STYLESHEET_FILENAME" => "css/sistema.css", // Project stylesheet file name
	...
	"PROJECT_ID" => "{448C0B4B-C32A-40EF-8151-41E96F03E813}", // Project ID (GUID)
	...
	"AUTH_CONFIG" => [
		"providers" => [
			...
			"Facebook" => [
				"enabled" => TRUE,
				"keys" => ["id" => "1265887106882571", "secret" => "4a880678d5efe297b526dad28670be7f"],
				"color" => "primary"
			]
		],
		"debug_mode" => FALSE,
	...
	"CONNECTION_INFO" => [
		"DB" => ["id" => "DB", "type" => "MYSQL", "qs" => "`", "qe" => "`", "host" => "localhost", "port" => "3306", "user" => "root", "pass" => "123456", "db" => "db_academia_sistema"]
	],
	...
	"USE_SUBQUERY_FOR_MASTER_USER_ID" => TRUE,

	// Default User ID allowed permissions
	"DEFAULT_USER_ID_ALLOW_SECURITY" => 360,

	// User table/field names
	"USER_TABLE_NAME" => "pessoa",
	"LOGIN_USERNAME_FIELD_NAME" => "Nome",
	"LOGIN_PASSWORD_FIELD_NAME" => "Senha",
	"USER_ID_FIELD_NAME" => "idpessoa",
	"PARENT_USER_ID_FIELD_NAME" => "",
	"USER_LEVEL_FIELD_NAME" => "Funcao",
	"USER_PROFILE_FIELD_NAME" => "Sessao",
	"REGISTER_ACTIVATE_FIELD_NAME" => "Ativado",
	"USER_EMAIL_FIELD_NAME" => "Email",

	// User table filters
	"USER_TABLE_DBID" => "DB",
	"USER_TABLE" => "`pessoa`",
	"USER_NAME_FILTER" => "(`Nome` = '%u')",
	"USER_ID_FILTER" => "(`idpessoa` = %u)",
	"USER_EMAIL_FILTER" => "(`Email` = '%e')",
	"USER_ACTIVATE_FILTER" => "(`Ativado` = 1)",
	...
	"SENDER_EMAIL" => "vinnepaul@gmail.com", // Sender email address
