...
?>
<div class="social-auth-links text-center mt-3">
	<a class="card-link mr-2" href="#" onclick="<?php echo $LoginStatus["forgotPasswordUrl"] ?>"><?php echo $Language->phrase("ForgotPwd") ?></a>
	<a class="card-link mr-2" href="#" onclick="<?php echo $LoginStatus["registerUrl"] ?>"><?php echo $Language->phrase("Register") ?></a>
</div>
</div>
</div>
</div>
