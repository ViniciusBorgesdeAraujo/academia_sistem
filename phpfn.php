...
class Breadcrumb
{
	...
	{
		global $Language;
		$this->Links[] = ["home", "HomePage", "home.php", "ew-home", "", FALSE]; // Home
	}
...
function SetupLoginStatus() {
	...
	$forgotPasswordPage = "forgotpwd.php";
	$forgotPasswordUrl = "";
	if ($currentPage != $forgotPasswordPage) {
		$forgotPasswordUrl = "window.location='" . GetUrl($forgotPasswordPage) . "';return false;";
	}
	$LoginStatus["forgotPasswordUrl"] = $forgotPasswordUrl;
	$LoginStatus["forgotPasswordText"] = $Language->phrase("ForgotPwd");
	$LoginStatus["canForgotPassword"] = $forgotPasswordUrl && !IsLoggedIn();
