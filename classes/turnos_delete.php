 ...
 * Page class
 */
class turnos_delete extends turnos
{
	...
	// Page object name
	public $PageObjName = "turnos_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("turnoslist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("turnoslist.php"); // Return to list
			}
		}
	}
