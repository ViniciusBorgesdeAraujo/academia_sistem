 ...
 * Page class
 */
class documentos_delete extends documentos
{
	...
	// Page object name
	public $PageObjName = "documentos_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("documentoslist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($rs = LoadRecordset($sql, $conn)) {
			...
			$rs->close();
			if (!$res) {
				$this->terminate("documentoslist.php"); // Return to list
				return;
			}
		}
