...
class index
{
	...
	public function run()
	{
		...
		if ($Security->allowList(CurrentProjectID() . 'pessoa'))
			$this->terminate("pessoalist.php");
		if ($Security->allowList(CurrentProjectID() . 'documentos'))
			$this->terminate("documentoslist.php");
		if ($Security->allowList(CurrentProjectID() . 'endereco'))
			$this->terminate("enderecolist.php");
		if ($Security->allowList(CurrentProjectID() . 'academia'))
		...
		if ($Security->allowList(CurrentProjectID() . 'videos'))
