 ...
 * Page class
 */
class documentos_add extends documentos
{
	...
	// Page object name
	public $PageObjName = "documentos_add";
	...
	public function run()
	{
		...
		if (IsApi()) {
			...
			if (Get("iddocumentos") !== NULL) {
				...
				$this->setKey("iddocumentos", $this->iddocumentos->CurrentValue); // Set up key
			} else {
				$this->setKey("iddocumentos", ""); // Clear key
		...
		switch ($this->CurrentAction) {
			case "copy": // Copy an existing record
				if (!$loaded) { // Record not loaded
					...
					$this->terminate("documentoslist.php"); // No matching record, return to list
				}
				break;
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "documentosview.php")
