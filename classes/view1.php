...
class view1 extends DbTable
{
	...
	public function __construct()
	{
		...
		// idaulas
		$this->idaulas = new DbField('view1', 'view1', 'x_idaulas', 'idaulas', '`idaulas`', '`idaulas`', 3, 11, -1, FALSE, '`idaulas`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// nome
		$this->nome = new DbField('view1', 'view1', 'x_nome', 'nome', '`nome`', '`nome`', 200, 25, -1, FALSE, '`nome`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// turmas
		$this->turmas = new DbField('view1', 'view1', 'x_turmas', 'turmas', '`turmas`', '`turmas`', 200, 45, -1, FALSE, '`turmas`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ativado
		$this->ativado = new DbField('view1', 'view1', 'x_ativado', 'ativado', '`ativado`', '`ativado`', 3, 11, -1, FALSE, '`ativado`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'RADIO');
		$this->ativado->Nullable = FALSE; // NOT NULL field
		$this->ativado->Required = TRUE; // Required field
		$this->ativado->Sortable = TRUE; // Allow sort
		switch ($CurrentLanguage) {
			case "pt-BR":
				$this->ativado->Lookup = new Lookup('ativado', 'view1', FALSE, '', ["","","",""], [], [], [], [], [], [], '', '');
				break;
			default:
				$this->ativado->Lookup = new Lookup('ativado', 'view1', FALSE, '', ["","","",""], [], [], [], [], [], [], '', '');
				break;
