 ...
 * Page class
 */
class academia_delete extends academia
{
	...
	// Page object name
	public $PageObjName = "academia_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("academialist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("academialist.php"); // Return to list
			}
		}
	}
