 ...
 * Page class
 */
class documentos_view extends documentos
{
	...
	// Page object name
	public $PageObjName = "documentos_view";
	...
	public function __construct()
	{
		...
		if (Get("iddocumentos") !== NULL) {
			$this->RecKey["iddocumentos"] = Get("iddocumentos");
			$keyUrl .= "&amp;iddocumentos=" . urlencode($this->RecKey["iddocumentos"]);
		}
	...
	public function run()
	{
		...
		$this->iddocumentos->setVisibility();
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("iddocumentos") !== NULL) {
				...
				$this->RecKey["iddocumentos"] = $this->iddocumentos->QueryStringValue;
				...
				$this->RecKey["iddocumentos"] = $this->iddocumentos->FormValue;
			} elseif (IsApi() && Route(2) !== NULL) {
				$this->iddocumentos->setFormValue(Route(2));
				$this->RecKey["iddocumentos"] = $this->iddocumentos->FormValue;
			} else {
				$returnUrl = "documentoslist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "documentoslist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "documentoslist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
