...
/**
 * Table class for view_aulasturnos
 */
class view_aulasturnos extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 'view_aulasturnos';
		$this->TableName = 'view_aulasturnos';
		$this->TableType = 'VIEW';

		// Update Table
		$this->UpdateTable = "`view_aulasturnos`";
		$this->Dbid = 'DB';
		$this->ExportAll = TRUE;
		...
		// idaulas
		$this->idaulas = new DbField('view_aulasturnos', 'view_aulasturnos', 'x_idaulas', 'idaulas', '`idaulas`', '`idaulas`', 3, 11, -1, FALSE, '`idaulas`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// nome
		$this->nome = new DbField('view_aulasturnos', 'view_aulasturnos', 'x_nome', 'nome', '`nome`', '`nome`', 200, 25, -1, FALSE, '`nome`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// turmas
		$this->turmas = new DbField('view_aulasturnos', 'view_aulasturnos', 'x_turmas', 'turmas', '`turmas`', '`turmas`', 200, 45, -1, FALSE, '`turmas`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		$this->turmas->Sortable = TRUE; // Allow sort
		...
		// ativado
		$this->ativado = new DbField('view_aulasturnos', 'view_aulasturnos', 'x_ativado', 'ativado', '`ativado`', '`ativado`', 3, 11, -1, FALSE, '`ativado`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'RADIO');
		$this->ativado->Nullable = FALSE; // NOT NULL field
		$this->ativado->Required = TRUE; // Required field
		$this->ativado->Sortable = TRUE; // Allow sort
		switch ($CurrentLanguage) {
			case "en":
				$this->ativado->Lookup = new Lookup('ativado', 'view_aulasturnos', FALSE, '', ["","","",""], [], [], [], [], [], [], '', '');
				break;
			case "pt-BR":
				$this->ativado->Lookup = new Lookup('ativado', 'view_aulasturnos', FALSE, '', ["","","",""], [], [], [], [], [], [], '', '');
				break;
	...
	{
		return ($this->SqlFrom != "") ? $this->SqlFrom : "`view_aulasturnos`";
	}
	...
	public function getReturnUrl()
	{
		...
		if (@$_SESSION[$name] != "") {
			...
			return "view_aulasturnoslist.php";
		}
	}
	...
	{
		global $Language;
		if ($pageName == "view_aulasturnosview.php")
			return $Language->phrase("View");
		elseif ($pageName == "view_aulasturnosedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "view_aulasturnosadd.php")
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("view_aulasturnosview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("view_aulasturnosview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
	...
	{
		if ($parm != "")
			$url = "view_aulasturnosadd.php?" . $this->getUrlParm($parm);
		else
			$url = "view_aulasturnosadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("view_aulasturnosedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("view_aulasturnosadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("view_aulasturnosdelete.php", $this->getUrlParm());
	}
